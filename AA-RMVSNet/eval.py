...
def save_depth():
    ...
    if "module.feature.conv0_0.0.weight" in state_dict['model'] or "module" in list(state_dict['model'].keys())[0]:
...
def filter_depth(scan_folder, out_folder, plyfilename):
    ...
    for ref_view, src_views in pair_data:
        ...
        geo_mask = geo_mask_sum >= 1  # TODO: check (Cas = 5, MVS = 3)
        ...
        color = ref_img[1::3, 1::3, :][valid_points]  # hardcoded for DTU dataset
...
if __name__ == '__main__':
    ...
    #     filter_depth(scan_folder, out_folder, os.path.join(args.outdir, 'aa-rmvsnet{}_.ply'.format(scan_id)))
